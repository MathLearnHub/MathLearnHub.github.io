...
async function smartLoadGame(id) {
    ...
    if (id === "FNAF") {
        iframe.src = `mathlearnhub.github.io/hd_fnaf/1/index.html`;
        return;
    }
    if (id === "FNAF2") {
        iframe.src = `mathlearnhub.github.io/hd_fnaf/2/index.html`;
        return;
    }
    if (id === "FNAF") {
        iframe.src = `mathlearnhub.github.io/hd_fnaf/3/index.html`;
        return;
    }
